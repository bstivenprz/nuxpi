...
export function EyeSlashIcon(props: Readonly<IconProps>) {
  return (
    <svg
      height={20}
      viewBox="0 0 640 512"
    ...
    return (
      <Input
        ...
        endContent={
          ...
          >
            {isVisible ? (
              <EyeSlashIcon className="text-default-400 hover:text-foreground cursor-pointer text-2xl transition" />
            ) : (
              <EyeIcon className="text-default-400 hover:text-foreground cursor-pointer text-2xl transition" />
            )}
          </button>
        }
        ref={ref}
